  ...
  const customerHtml = `
    <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; background: #0f0d09; color: #F5CBA7; border-radius: 16px; overflow: hidden;">
      ...
      <div style="padding: 32px;">
        <p style="font-family: sans-serif; font-size: 15px; margin: 0 0 24px;">Hi! Your booking for <strong>${dogName}</strong> is confirmed and your card has been charged.</p>
        <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 14px;">
          <tr><td style="padding: 12px 0; color: rgba(245,203,167,0.55);">Service</td><td style="padding: 12px 0; font-weight: bold;">${serviceName}</td></tr>
          <tr><td style="padding: 12px 0; color: rgba(245,203,167,0.55);">Pet</td><td style="padding: 12px 0; font-weight: bold;">${dogName} (${speciesLabel})</td></tr>
